...
// 首页资料列表
export const files_data_list = data => {
	return http.post('/industry/api/files_data_list', data)
}
// 首页新闻列表
export const news_list = data => {
	return http.post('/industry/api/news_list', data)
}
// 视频资料详情
export const video_info = data => {
	return http.post('/industry/api/video_info', data)
}
// 视频资料详情中推荐列表
export const video_recommend = data => {
	return http.post('/industry/api/video_recommend', data)
}
// 新闻/视频/文档的评论列表
export const comments_list = data => {
	return http.post('/industry/api/comments_list', data)
}
// 文档资料详情
export const file_info = data => {
	return http.post('/industry/api/file_info', data)
}
// 我购买的资料
export const user_buyfiles = data => {
	return http.post('/industry/api/user_buyfiles', data)
}
//资料-视频列表
export const video_list = data =>{
    return http.post('/industry/api/video_list', data)
}
//资料-文档列表
export const files_list = data =>{
    return http.post('/industry/api/files_list', data)
}