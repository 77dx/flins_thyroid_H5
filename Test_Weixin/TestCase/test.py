...
class TestH5(unittest.TestCase):
    ...
    def atest_02(self):
        try:
            ...
            # 如果图片上传失败，再次执行该页面的case
            if (self.mi9_h5Driver.isElementExist('//*[@id="app"]/div/div[2]')):
                pass
            else:
                print '图片上传失败，重新上传'
                self.B_report(d2)
    ...
    def index(self,vivo_h5Driver):
        ...
        # 点击同意协议
        self.vivo_h5Driver.clickElementByXpath('//*[@id="app"]/div/div/div/label')
        # 点击去测评
        self.vivo_h5Driver.clickElementByXpath('//*[@id="app"]/div/div/a[2]')
    ...
    def B_report(self,d2):
        ...
        self.mi9_h5Driver.clickElementByXpath('/html/body/div[6]/div/div[2]/div[2]/div/div[2]/div[1]/div[3]/span')#选择体检时间
        # 提交报告
