...
if DEBUG:
    DATABASES = {
        'default': {
            ...
            'USER': 'root',  # 数据库登录名
            'PASSWORD': 'dx396321556',  # 数据库登录密码
            'HOST': '134.175.9.133',  # 数据库所在服务器ip地址
...
EMAIL_SEND_USERNAME = '396321556@qq.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = 'qgtlypdphibpcahj'     # 邮箱密码
